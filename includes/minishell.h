...
/*   Updated: 2026/07/02 14:12:05 by ecardoua         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	exec_with_direct_path(t_cmd *cmd, char **argv, char **env_cpy, t_data *data);
...
void	exec_search_path_bis(t_cmd *cmd, char **argv, t_data *data, char *full_path);
...
bool	env_val_need_split_exp(t_classic *clas, t_data *data, int s_quote, int d_quote);
